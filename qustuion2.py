...
var = tk.StringVar() 
l = tk.Label(window, bg='skyblue', width=200, height=100, text='') 
l.pack() 
...
lb1 = tk.Label(window, text="First Name:", width=12, font=("arial", 13)) 
lb1.place(x=20, y=40) 
en1 = tk.Entry(window) 
en1.place(x=180, y=40) 
 
lb3 = tk.Label(window, text="Last Name:", width=12, font=("arial", 13)) 
lb3.place(x=20, y=70) 
en3 = tk.Entry(window) 
en3.place(x=180, y=70) 
 
# lb4 = tk.Label(window, text="Contact Number", width=13, font=("arial", 13)) 
# lb4.place(x=20, y=100) 
# en4 = tk.Entry(window) 
# en4.place(x=200, y=100) 
 
lb5 = tk.Label(window, text="Select Gender:", width=12, font=("arial", 13)) 
...
lb6 = tk.Label(window, text="Languages:", width=12, font=("arial", 13)) 
...
lb7 = tk.Label(window, text="Email:",width=12, font=("arial", 13)) 
lb7.place(x=20, y=160) 
en4 = tk.Entry(window) 
en4.place(x=180, y=160) 
 
lb7 = tk.Label(window, text="Address:",width=12, font=("arial", 13)) 
...
cv.set("Choose State") 
lb2 = tk.Label(window, text="State", width=12, font=("arial", 13)) 
lb2.place(x=20, y=280) 
drplist.place(x=180, y=280) 
 
lb6 = tk.Label(window, text="Zip", width=12, font=("arial", 13)) 
